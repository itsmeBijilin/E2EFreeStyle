...
public class ExtendReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		*/
		...
		sparkReporter.config().setDocumentTitle("Allegiant Automation Report"); // Title of report
		sparkReporter.config().setReportName("Allegiant Functional Testing"); // name of the report
		sparkReporter.config().setTheme(Theme.DARK);
		
		extent = new ExtentReports();
		extent.attachReporter(sparkReporter);
		extent.setSystemInfo("Application", "Allegiant");
		extent.setSystemInfo("Module", "QA");
