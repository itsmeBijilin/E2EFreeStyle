...
public void onStart(ITestContext context) {
	...
	sparkReporter=new ExtentSparkReporter(System.getProperty("user.dir")+"/report1/"+repName);
...
//	String pathOfExtentReport = System.getProperty("user.dir")+"\\report1\\"+repName;
